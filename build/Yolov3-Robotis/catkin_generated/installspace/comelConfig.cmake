...
if(NOT "include;/usr/include/opencv4 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'comel' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bayimaung/cicii_ws/install/lib;/home/bayimaung/cicii_ws/devel/lib;/home/bayimaung/puci_ws/devel/lib;/opt/ros/noetic/lib)
